...
m_funcion_x.append(lambda U,V: (U[11] / 2)*(U[12] - 1) + (V[11] / 2 )*(U[18] - U[6]) - U[12] - 1 + 4*U[11] - U[18] - U[6])
...
m_funcion_jacobiana_x[2][2] = (lambda U,V: (U[3] - U[1]) / 2 + 4 )
...
m_funcion_jacobiana_x[3][3] = (lambda U,V: (U[4] - U[2]) / 2 + 4 )
...
m_funcion_jacobiana_x[4][4] = (lambda U,V: (U[5] - U[3]) / 2 + 4 )
m_funcion_jacobiana_x[4][5] = (lambda U,V: (U[4] / 2) - 1 )
m_funcion_jacobiana_x[4][3] = (lambda U,V: -(U[4] / 2) - 1 )
...
m_funcion_jacobiana_x[7][1] = (lambda U,V: -1*(V[7] / 2) - 1 )

m_funcion_jacobiana_x[8][8] = (lambda U,V: (U[9] - U[7]) / 2 + 4 )
...
m_funcion_jacobiana_x[8][2] = (lambda U,V: -1*(V[8] / 2) - 1 )
    
m_funcion_jacobiana_x[9][9] = (lambda U,V: (U[10] - U[8]) / 2 + 4 )
...
m_funcion_jacobiana_x[9][3] = (lambda U,V: -1*(V[9] / 2) - 1 )

m_funcion_jacobiana_x[10][10] = (lambda U,V: -1*(U[9]) + 4 )
m_funcion_jacobiana_x[10][9] = (lambda U,V: -1*(U[10] / 2) - 1 )
m_funcion_jacobiana_x[10][4] = (lambda U,V: -1*(V[10] / 2) - 1 )
...
m_funcion_jacobiana_x[12][12] = (lambda U,V: (U[13] - U[11]) / 2 + 4 )
...
m_funcion_jacobiana_x[13][13] = (lambda U,V: (U[14] - U[12]) / 2 + 4 )
...
m_funcion_jacobiana_x[14][14] = (lambda U,V: (U[15] - U[13]) / 2 + 4 )
m_funcion_jacobiana_x[14][15] = (lambda U,V: (U[14] / 2) - 1 )
m_funcion_jacobiana_x[14][13] = (lambda U,V: -1*(U[14] / 2) - 1 )

m_funcion_jacobiana_x[15][15] = (lambda U,V: (U[16] - U[14]) / 2 + 4 )
...
m_funcion_jacobiana_x[16][16] = (lambda U,V: (U[17] - U[15]) / 2 + 4 )
...
m_funcion_jacobiana_x[19][19] = (lambda U,V: (U[20] - U[18]) / 2 + 4 )
...
m_funcion_jacobiana_x[23][23] = (lambda U,V: (U[24] - U[22]) / 2 + 4 )
...
m_funcion_jacobiana_x[27][27] = (lambda U,V: (U[28] / 2) + 3.5 )
m_funcion_jacobiana_x[27][28] = (lambda U,V: (U[27] / 2) - 1 )
m_funcion_jacobiana_x[27][33] = (lambda U,V: (V[27] / 2) - 1 )
m_funcion_jacobiana_x[27][22] = (lambda U,V: -1*(V[27] / 2) - 1 )
    #Quede aqui P28
    
m_funcion_jacobiana_x[28][28] = (lambda U,V: (U[29] - U[27]) / 2 + 4 )
m_funcion_jacobiana_x[28][29] = (lambda U,V: (U[28] / 2) - 1 )
m_funcion_jacobiana_x[28][27] = (lambda U,V: -1*(U[28] / 2) - 1 )
m_funcion_jacobiana_x[28][34] = (lambda U,V: (V[28] / 2) - 1 )
m_funcion_jacobiana_x[28][23] = (lambda U,V: -1*(V[28] / 2) - 1 )

m_funcion_jacobiana_x[29][29] = (lambda U,V: -1*(U[28] /2) + 4 )
m_funcion_jacobiana_x[29][28] = (lambda U,V: -1*(U[29] / 2) - 1 )
m_funcion_jacobiana_x[29][34] = (lambda U,V: (V[29] / 2) - 1 )
m_funcion_jacobiana_x[29][24] = (lambda U,V: -1*(V[29] / 2) - 1 )

m_funcion_jacobiana_x[30][30] = (lambda U,V: (U[31] / 2) + 4 )
m_funcion_jacobiana_x[30][31] = (lambda U,V: (U[30] / 2) - 1 )
m_funcion_jacobiana_x[30][36] = (lambda U,V: (V[30] / 2) - 1 )
m_funcion_jacobiana_x[30][25] = (lambda U,V: -1*(V[30] / 2) - 1 )

m_funcion_jacobiana_x[31][31] = (lambda U,V: (U[32] - U[30]) / 2 + 4 )
m_funcion_jacobiana_x[31][32] = (lambda U,V: (U[31] / 2) - 1 )
m_funcion_jacobiana_x[31][30] = (lambda U,V: -1*(U[31] / 2) - 1 )
m_funcion_jacobiana_x[31][37] = (lambda U,V: (V[31] / 2) - 1 )
m_funcion_jacobiana_x[31][26] = (lambda U,V: -1*(V[31] / 2) - 1 )

m_funcion_jacobiana_x[32][32] = (lambda U,V: -1*(U[31] / 2) + 4 )
m_funcion_jacobiana_x[32][31] = (lambda U,V: -1*(U[32] / 2) - 1 )
m_funcion_jacobiana_x[32][38] = (lambda U,V: (V[32] / 2) - 1 )

m_funcion_jacobiana_x[33][33] = (lambda U,V: (U[34] / 2) + 3.5 )
m_funcion_jacobiana_x[33][34] = (lambda U,V: (U[33] / 2) - 1 )
m_funcion_jacobiana_x[33][27] = (lambda U,V: -1*(V[33] / 2) - 1 )

m_funcion_jacobiana_x[34][34] = (lambda U,V: (U[35] - U[33]) / 2 + 4 )
m_funcion_jacobiana_x[34][35] = (lambda U,V: (U[34] / 2) - 1 )
m_funcion_jacobiana_x[34][33] = (lambda U,V: -1*(U[34] / 2) - 1 )
m_funcion_jacobiana_x[34][28] = (lambda U,V: -1*(V[34] / 2) - 1 )

m_funcion_jacobiana_x[35][35] = (lambda U,V: -1*(U[34] / 2) + 4 )
m_funcion_jacobiana_x[35][34] = (lambda U,V: -1*(U[35] / 2) - 1 )
m_funcion_jacobiana_x[35][29] = (lambda U,V: -1*(V[35] / 2) - 1 )

m_funcion_jacobiana_x[36][36] = (lambda U,V: (U[37] / 2) + 4 )
m_funcion_jacobiana_x[36][37] = (lambda U,V: (U[36] / 2) - 1 )
m_funcion_jacobiana_x[36][30] = (lambda U,V: -1*(V[36] / 2) - 1 )

m_funcion_jacobiana_x[37][37] = (lambda U,V: (U[38] - U[36]) / 2 + 4 )
m_funcion_jacobiana_x[37][38] = (lambda U,V: (U[37] / 2) - 1 )
m_funcion_jacobiana_x[37][36] = (lambda U,V: -1*(U[37] / 2) - 1 )
m_funcion_jacobiana_x[37][31] = (lambda U,V: -1*(V[37] / 2) - 1 )

m_funcion_jacobiana_x[38][38] = (lambda U,V: -1*(U[37] / 2) + 4 )
m_funcion_jacobiana_x[38][37] = (lambda U,V: -1*(U[38] / 2) - 1 )
m_funcion_jacobiana_x[38][32] = (lambda U,V: -1*(V[38] / 2) - 1 )

def m_x():
    return m_funcion_x

def m_j_x():
    return m_funcion_jacobiana_x
